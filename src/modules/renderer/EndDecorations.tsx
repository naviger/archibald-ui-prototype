...
export const getEndDecoration = (id:string, relationship:EdgeRelationships, pos:Position, origin:Position, theta:number, styles:StyleObject):JSX.Element => {
  ...
  switch(relationship) {
    case EdgeRelationships.Access:
      ...
      return  (<polyline id={id + ":end"} points={pts} width={styles.strokeSize} strokeDasharray={styles.strokeStyle} stroke={styles.strokeColor} fill={"none"} />)
      break;
    ...
    case EdgeRelationships.Assignment:
      ...
      return  (<polyline id={id + ":end"} points={pts} width={styles.strokeSize} strokeDasharray={styles.strokeStyle} stroke={styles.strokeColor} fill={styles.strokeColor} />)
      break
    ...
    case EdgeRelationships.Flow:
      ...
      return  (<polyline id={id + ":end"} points={pts} width={styles.strokeSize} strokeDasharray="1 0" stroke={styles.strokeColor} fill={styles.strokeColor} />)
      break
    ...
    case EdgeRelationships.Realization:
      ...
      return  (<polyline id={id + ":end"} points={pts} width={styles.strokeSize} strokeDasharray={styles.strokeStyle} stroke={styles.strokeColor} fill="white" />)
      break
